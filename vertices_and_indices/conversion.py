...
def convert_indices_format(line):
    ...
    if components[0] == 'f':
        ...
        # Face dengan 4 vertex (quad)
            ...
            # Quad dipecah menjadi dua segitiga
            triangle_1 = f"{webgl_first}, {webgl_second}, {webgl_third},"
            triangle_2 = f"{webgl_first}, {webgl_third}, {webgl_fourth},"

            # Gabungkan kedua segitiga
            return f"{triangle_1} {triangle_2}"
